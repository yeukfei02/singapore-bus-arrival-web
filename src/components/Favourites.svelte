        ...
        {#each data.data.getFavouritesByInstallationId as item}
          <div class="container my-4">
            <Card>
              <Content>
                <div class="d-flex justify-content-end">
                  <IconButton
                    ...
                    title="Delete"
                    on:click={() =>
                      handleDeleteButtonClick(item.id, item.installation_id)}
                    >delete</IconButton
                  >
                </div>
                ...
                <div class="my-2" style="font-size: 1.2em;">
                  Bus Stop Code: <span
                    ...
                    on:click={() =>
                      handleBusStopCodeClick(item.item.bus_stop_code)}
                    >{item.item.bus_stop_code}</span
                  >
                </div>
                <span
              ...
              <Actions>
                <IconButton class="material-icons" title="Favorite"
                  >favorite</IconButton
                >
              </Actions>
            </Card>
