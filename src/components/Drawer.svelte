      ...
      <Content>
        <List>
          <Item
            ...
            on:click={() => handleNavBarItemClick("nearme")}
            activated={current === "nearme"}
          >
            <Text>NearMe</Text>
          </Item>
          <Item
            href="javascript:void(0)"
            on:click={() => handleNavBarItemClick("search")}
            activated={current === "search"}
          >
            <Text>Search</Text>
          </Item>
          <Item
            href="javascript:void(0)"
            on:click={() => handleNavBarItemClick("favourites")}
            activated={current === "favourites"}
          >
            <Text>Favourites</Text>
          </Item>
          <Item
            href="javascript:void(0)"
            on:click={() => handleNavBarItemClick("settings")}
            activated={current === "settings"}
          >
            <Text>Settings</Text>
          </Item>
        </List>
